...
- A bad line occurs when DEN=1 and `(Y AND $07) == YSCROLL`; VIC-II takes the bus for 40 character-fetch cycles, while CPU delay can be 40–43 cycles because of the BA lead-in.
